...
export const TransactionCard: React.FC<Props> = ({ tx, isAdmin, currentUserId, isArchived }) => {
  ...
  return (
    <div onClick={() => nav(`/transaction/${tx.id}`)} className="border-black border bg-white hover:drop-shadow-md hover:scale-105 rounded-2xl p-3 m-3 text-center transition max-w-3/4 mx-auto">
      ...
      {canEditOrDelete && <div className="border-t pt-3 mt-3 flex flex-wrap gap-3">
